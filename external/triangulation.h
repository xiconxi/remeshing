...
class TriangleWrapper {
    ...
    public:
         ...
         * Edge markers
         */
        void set_segment_markers(const VectorI& marker) { m_segment_markers = marker; }
        const VectorI& get_segment_markers() const { return m_segment_markers; }
        ...
        Float get_min_angle() const { return m_min_angle; }
        ...
        Float get_max_area() const { return m_max_area; }
        ...
        const MatrixIr& get_face_neighbors() const { return m_face_neighbors; }
        const MatrixIr& get_edges() const { return m_edges; }
        const VectorI& get_edge_marks() const { return m_edge_marks; }
